  ...
  return (
    <section className="bg-[var(--brand-gold)] text-[var(--brand-cream)]">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-6 px-6 py-9 lg:flex-row lg:items-center lg:px-10">
        ...
        <a
          className="inline-flex min-w-[200px] items-center justify-center bg-white px-8 py-3 text-xs tracking-[0.16em] text-[var(--brand-dark)] shadow-[0_10px_30px_rgba(32,24,18,0.28)] transition hover:bg-white/90"
          href="#"
        >
          Request a Quote
        </a>
